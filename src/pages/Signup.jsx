...
const Signup = () => {
    ...
    //   console.log(data);
    return (
        <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% h-[100dvh] grid place-items-center px-3">
            <form
                onSubmit={submit_handle}
                className="bg-slate-400 rounded-md max-w-md w-full py-6 px-3 grid grid-cols-2  gap-5"
            >
